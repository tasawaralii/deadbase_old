...
if ($_GET['type'] == "tv") {
    ...
    if ($_GET['season'] == "all") {
        ...
        foreach ($res as $row) {
            ...
            //   echo '<a rel="nofollow" href= "https://links.deadtoonsindia.cc/episode/'.$row['slug'].'/'.$row['my_season_num'].'x'.$row['epSort'].'">Watch Online</a>';
            echo '<a rel="nofollow" href= "' . $animeworld . "series/" . $row['slug'] . '">Watch Online</a>';
            echo '</strong></center>';
            echo "<hr>";
...
");
    ...
    echo "<center><strong><a rel='nofollow' href='" . $animeworld . "movies/" . $l[0]['slug'] . "'>Watch Online</a></strong></center><hr>";
